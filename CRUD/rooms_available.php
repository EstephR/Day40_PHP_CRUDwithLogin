...
// Insert Room Data - only for available rooms
...
<body>
  ...
  <div class="container">
    ...
    <h1 class="p-3 text-light text-center mt-3 mb-3">Book a Room</h1>
               ...
               <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?=$row["price"]?></td>
                        <td>
                                <a href="products/actions/a_book.php?id=<?=$row["id"]?>"><button class='btn btn-outline-success mb-2'>Book Now</button>
                        </td>
                   </tr>
                <?php 
                       }
